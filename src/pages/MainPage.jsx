...
import { isThisWeek, isThisTwoWeeks, formatShortDate, getCurrentWeekLabel, getMVP, getMVPStats, getMemberByKey, MEMBERS } from "../utils/helpers";
	...
	if (loading) {
		return (
			<main className="page-content">
				<div className="container" style={{ paddingTop: '4rem', textAlign: 'center', color: '#9488b0' }}>
					...
					<div className="hero__inner">
						<div className="hero__content">
							...
							<div className="hero__actions">
								<button className="hero__cta hero__cta--primary" onClick={() => navigate("/write")}>
									✏️ 기록 등록하기
								</button>
								<button className="hero__cta hero__cta--secondary" onClick={() => setShowGuideline(true)}>
									📋 운영지침
								</button>
							</div>
					...
					<section>
						<div className="record-section__title">
							<div className="record-section__title-left">
								전체 기록
								<span className="record-section__count">{records.length}편</span>
							</div>
	...
	return (
		<div className="record-item" onClick={onClick}>
			...
			<div className="record-item__body">
				...
				{record.chapter && (
					<span className="record-item__chapter">📖 {record.chapter}</span>
				)}
